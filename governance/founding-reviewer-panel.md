# Founding Reviewer Panel

## Purpose

Record who the founder has manually appointed to review Catholic Context knowledge proposals during the founding stage.

Appointment here is a **project governance** act. It does not claim Church office, diocesan faculties, or Magisterial authority. Reviewers help ensure Catholic Context faithfully represents sources; they do not define doctrine.
...
|---|---|---|---|
| **Channing Decker** | Theological reviewer (founding) | **Appointed** | First appointed reviewer. Lay theologian by vocation and study; guided the founder into Catholicism. |
...
- **Platform public username:** `channing` (reserved via founder appoint API when email is provided)
- **Platform user id:** *assigned at first magic-link login*
- **GitHub account:** Not required
- **Appointment API:** `POST /api/admin/appoint` with founder token (see `website/README.md`)
...
Qualified lay theologians may serve. Clerical status is not required for founding-panel appointment.
