...
4. [`DESIGN_FIDELITY.md`](DESIGN_FIDELITY.md) — locked high-fidelity My Catholic Guide-derived visual tokens and precedence
5. [`DESIGN_SYSTEM.md`](DESIGN_SYSTEM.md) — CatholicContext.org UX/design principles and page guidance
6. [`WEBSITE_IMPLEMENTATION.md`](WEBSITE_IMPLEMENTATION.md) — website implementation and MVP acceptance criteria
