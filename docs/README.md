...
6. [`DESIGN_FIDELITY.md`](DESIGN_FIDELITY.md) — locked high-fidelity My Catholic Guide-derived visual tokens and precedence
7. [`DESIGN_SYSTEM.md`](DESIGN_SYSTEM.md) — CatholicContext.org UX/design principles and page guidance
8. [`WEBSITE_IMPLEMENTATION.md`](WEBSITE_IMPLEMENTATION.md) — website implementation and MVP acceptance criteria
9. [`../GOVERNANCE.md`](../GOVERNANCE.md) — founding governance principles
10. [`theological-review.md`](theological-review.md) — theological review workflow
11. [`authority-model.md`](authority-model.md) — source/authority modeling approach
12. [`SOURCE_RIGHTS.md`](SOURCE_RIGHTS.md) — third-party source rights and ingestion limits
13. [`../sources/README.md`](../sources/README.md) — source registry and candidate-source evaluations
14. [`../harness/README.md`](../harness/README.md) — Catholic Harness foundation
15. [`../evals/README.md`](../evals/README.md) — Catholic Evals foundation
16. [`../schema/catholic-context.schema.json`](../schema/catholic-context.schema.json) — canonical knowledge-object schema
17. [`../LICENSING.md`](../LICENSING.md) — licensing model and third-party content boundary
