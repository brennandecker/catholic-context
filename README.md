...
It is also not a digital library of source texts and not an identifier registry. [New Advent](https://www.newadvent.org/) hosts editions to read; [CatholicOS](https://github.com/orgs/CatholicOS) names Catholic realities for software. Catholic Context sits between those and applications: sourced knowledge objects, an AI Harness, and public Evals. See [`docs/related-projects.md`](docs/related-projects.md). Near-term work is ordered in [`docs/priorities.md`](docs/priorities.md). The next five major features, with files and acceptance criteria, are in [`docs/feature-plan.md`](docs/feature-plan.md).
