...
function writeLlmsTxt(entries) {
  ...
  const lines = [
    ...
    `- [Magnifica Humanitas presentation](${SITE}/) — official Vatican presentation film, played on the home page`,
    `- [Pope Leo XIV full speech](${SITE}/harness) — full address at the Magnifica Humanitas Vatican launch, played on /harness`,
    `- [Evals](${SITE}/evals)`,
